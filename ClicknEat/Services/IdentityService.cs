...
namespace ClicknEat.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(RoleManager<IdentityRole> roleManager, UserManager<IdentityUser> userManager, JwtSettings jwtSettings, TokenValidationParameters tokenValidationParameters, ApplicationDbContext context)
        {
